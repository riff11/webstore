...
( 'UE22H5600AKXUA', 2134, 3, 7,  'Благодаря классическому дизайну и простым в использовании функциям серия телевизор  предлагает превосходное качество по доступной цене.', 1),
...
( 'GoodNotebook432', 6323.98, 4, 6, 'Экран 13.3" IPS (3200x1800) QHD+, матовый / Intel Core i5-6200U (2.3 - 2.8 ГГц)', 1),
( 'bestVacuum', 6323.98, 5, 11, 'Тип пылесоса: с мешком. Тип уборки: сухая. Потребляемая мощность: 2000 Вт', 1),
( 'Oven-best', 6323.98, 2, 12, 'the best oven ever', 1),
( 'ProCam', 6323.98, 1, 8, 'Разрешение видео: Full HD (1920x1080) Тип носителя: Flash память Матрица (светочувствительный элемент): 1/5.8" (3.1 мм) Exmor R CMOS с тыловой подсветкой', 1),
( 'Super Oven', 6323.98, 5, 12, 'Комбинированная плита от компании на четыре газовые конфорки с мультифункциональной духовкой объемом 48 литров', 1),
( 'Notebook365', 6323.98, 8, 6,  'Экран 15.6" (1366x768) HD, глянцевый / Intel Celeron N3060', 1),
( 'Good Laptop', 6323.98, 6, 6, '/ Intel HD Graphics 400 / без ОД / LAN / Wi-Fi / Bluetooth / веб-камера / DOS / 2.2 кг / черный', 1);
